 ...
 */
public class GoldModel implements IOldGameModel {
	...
	public void setGameboardState(final int x, final int y, final IGameTile tile) {
		gameBoard[x][y] = tile;
	}
	...
	//TODO Maybe fill this array with values?
	IGameTile[][] gameBoard = new IGameTile[getGameboardSize().width][getGameboardSize().height];
	/*
